...
# Default EXPORT_SECRET_KEY if not set in .env.local
EXPORT_SECRET_KEY="${EXPORT_SECRET_KEY:-ap_sec_63b2120c11dccdc10159ae284379b01d}"
...
gcloud run deploy wedding-website \
  ...
  --set-env-vars="NEXT_PUBLIC_SUPABASE_URL=$NEXT_PUBLIC_SUPABASE_URL,NEXT_PUBLIC_SUPABASE_ANON_KEY=$NEXT_PUBLIC_SUPABASE_ANON_KEY,NEXT_PUBLIC_MAPBOX_TOKEN=$NEXT_PUBLIC_MAPBOX_TOKEN,GEMINI_API_KEY=$GEMINI_API_KEY,SUPABASE_SERVICE_ROLE_KEY=$SUPABASE_SERVICE_ROLE_KEY,EXPORT_SECRET_KEY=$EXPORT_SECRET_KEY"
